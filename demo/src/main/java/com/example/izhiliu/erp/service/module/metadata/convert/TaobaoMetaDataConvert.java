 ...
 */
@Component
public class TaobaoMetaDataConvert implements MetaDataConvert<TaobaoMetaDataConvert.TaoBaoMetaData> {
    ...
    @Override
    public ProductMetaDataDTO collect(TaoBaoMetaData data) {
        ...
        final List<String> images = Arrays.stream(productInfo.getImage().getImages())
            .map(TaobaoMetaDataConvert::getImage)
        ...
        metaData.setPlatform(PlatformEnum.TAOBAO.getName());
        metaData.setPlatformId(PlatformEnum.TAOBAO.getCode().longValue());
     ...
     */
    @Data
    public static class TaoBaoMetaData extends BaseMetaData {

        private AlibabaProductProductInfoPlus productInfo;

        public TaoBaoMetaData(Integer platformId, String json, String loginId, String url, AlibabaProductProductInfoPlus productInfo) {
