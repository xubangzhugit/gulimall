 ...
 */
@Component
public class TianmaoMetaDataConvert implements MetaDataConvert<TianmaoMetaDataConvert.TianmaoMetaData> {

    public static final String IMAGE_PREFIX = "https://img.alicdn.com/";
    public static final String HTTPS_PREFIX = "https:";
    public static final String COM_PREFIX = "com";

    @Override
    public ProductMetaDataDTO collect(TianmaoMetaData data) {
        ...
        final List<String> images = Arrays.stream(productInfo.getImage().getImages())
            .map(TianmaoMetaDataConvert::getImage)
        ...
        metaData.setPlatform(PlatformEnum.TMALL.getName());
        metaData.setPlatformId(PlatformEnum.TMALL.getCode().longValue());
     ...
     */
    @Data
    public static class TianmaoMetaData extends BaseMetaData {

        private AlibabaProductProductInfoPlus productInfo;

        public TianmaoMetaData(Integer platformId, String json, String loginId, String url, AlibabaProductProductInfoPlus productInfo) {
